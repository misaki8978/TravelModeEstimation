...
#$ -e logs/05_segment/__PLACE_YEAR__/$TASK_ID.err
...
CHUNK_DIR="$DATA_DIR/interim/chunks/${PLACE}_${YEAR}_segment"
...
python3 /home/fukui/workspace/TravelModeEstimation/scripts/05_segmentation/01_segment_detection.py "${FILES[@]}"
